...
<%--            </div>--%>
        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
            <c:forEach var="homeEpisode" items="${requestScope.get('list')}">
                <tr>
                    <td>${homeEpisode.getId()}</td>
                    <td>${homeEpisode.getEpisode_id()}</td>
                    <td>
                        <a href="${pageContext.request.contextPath}/toUpdateHomeEpisode?id=${homeEpisode.getId()}">更改</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
