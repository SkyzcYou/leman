    ...
    <div class="layui-body">
        ...
        <div class="row">
            <div class="col-md-4 column">
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/toAddAnime">新增剧集</a>
            </div>
        </div>
        <table class="table table-hover table-striped">
            ...
            <tbody>
            <c:forEach var="anime" items="${requestScope.get('list')}">
                <tr>
                    <td>${anime.getId()}</td>
                    <td>${anime.getName()}</td>
                    <td>${anime.getTip()}</td>
                    <td><img class="images" alt="" src="${pageContext.request.contextPath}/static/upload/${anime.pimage}"></td>
                    <td>
                    <td>
                        <a href="${pageContext.request.contextPath}/toUpdateAnime?id=${anime.getId()}">更改</a> |
                        <a href="${pageContext.request.contextPath}/delAnime/${anime.getId()}">删除</a>
                    </td>                    </td>
                </tr>
            </c:forEach>
            </tbody>
